      ...
      <div className="page fadeIn">
        <div className="Privacy page__content">
          ...
          <div style={{ maxWidth: 600 }}>
            ...
            <p>
              Modern Web Developer | Tawnee ("us", "we", or "our") operates the
              https://tawneeallport.com website (the "Service").
            </p>

            <p>
              This page informs you of our policies regarding the collection, use, and
              disclosure of personal data when you use our Service and the choices you
              have associated with that data. This Privacy Policy for Modern Web
              Developer | Tawnee is powered by{' '}
            ...
            <p>
              ...
              our Terms and Conditions, accessible from https://tawneeallport.com.
            </p>
            ...
            <p>
              Modern Web Developer | Tawnee uses the collected data for various
              purposes:
            </p>
            <ul>
            ...
            <p>
              Modern Web Developer | Tawnee will take all steps reasonably necessary
            ...
            <p>
              Modern Web Developer | Tawnee may disclose your Personal Data in the
              good faith belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Modern Web Developer |
                Tawnee
              </li>
              <li>
